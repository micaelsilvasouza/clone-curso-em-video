...
export default function AreaCurso({ curso, video, videos }: AreaCursoProp) {
  ...
  return (
    <section className="bg-violet-500 grid grid-rows-[150px_1fr_1fr] grid-cols-[100px_1fr_1fr]">
      {/* Primeira área da DIV - Menu Hamburguer */}
      <div
        onClick={() => setClickHamburguer(!clickHamburguer)}
        className="grid col-start-1 col-end-2 row-start-1 row-end-2 bg-amber-300 items-center justify-items-center"
      >
      ...
      <div className="bg-red-900  col-start-1 col-end-4 row-start-2 row-end-4 md:relative flex ">
        ...
        <div className="bg-rose-500 flex-1  h-dvh">
