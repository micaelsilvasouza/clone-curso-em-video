...
export function LinkClassVideo({
  ...
  return (
    ...
    >
      ...
      <span className={`shrink-0 size-8 border-5 ${video_watched || liberated ? "border-blue-800" : "border-gray-300"} rounded-full flex items-center justify-center`}>
        {video_watched ? 
      ...
      <Link 
        ...
        className={video_watched || liberated ? "hover:underline" : "text-gray-500 cursor-not-allowed"}
      >
